...
class AppColors {
  ...
  /// green
  static const binaryTreeNoPurchase = Color(0xffB9B9C3);
  static const green = Color(0xff28c76f);
  static const red = Color(0xffea5455);

  static const starOrange = Color(0xffFF9F43);
  static const greyAccesoryIconColor = Color(0xffB9B9C3);
  // static final primaryPurple10 = AppColors.primaryPurple.withOpacity(.1);
  static const primaryPurple10 = Color(0x197367f0);
